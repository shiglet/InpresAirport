...
public class SerTow extends javax.swing.JFrame {
    ...
    public SerTow() {
        ...
        bd.connectDB();
        TowerThread towerTh = new TowerThread(bd);
        towerTh.start();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SerTow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
